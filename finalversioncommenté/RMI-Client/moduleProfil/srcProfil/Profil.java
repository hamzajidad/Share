...
public class Profil implements Serializable{
	...
	/*
	 * Constructeur d'un profil avec des parametres rentres a la main
	 * 
	 * */
	public Profil(String login,String nom, String prenom, String email, String fonction, String mdp, String statut) {
		idProfil = login;
		this.nom = nom;
		this.prenom = prenom;
		this.email = email;
	...
	public void creerUnProfil(String mdp, String statutCreateur) throws MalformedURLException, RemoteException, NotBoundException{
		Remote r = Naming.lookup("rmi://"+Client.getUrl()+"/Profil");
		((ProfilInterface) r).creerProfil(idProfil, nom, prenom, fonction, email, mdp, statut, statutCreateur);
