...
public class AfficherUnProfilIHM {
	 ...
	 */
	public AfficherUnProfilIHM() throws RemoteException, MalformedURLException, NotBoundException {
		initialize();
	}
	...
	private void initialize() throws RemoteException, MalformedURLException, NotBoundException {
		...
		JLabel lblNewLabel_3 = new JLabel(profil.getMdp(LoginIHM.utilisateur.getStatut()));
